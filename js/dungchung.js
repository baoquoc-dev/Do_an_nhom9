...
function addHeader() {
	...
	<div class="header group">
        <div class="logo">
            <a href="index.html">
                <img src="img/logo.png" alt="Trang chủ Smartphone Store">
            </a>
        </div> <!-- End Logo -->
    ...
    <div class="plc">
        <section>
            <ul class="flexContain">
                ...
                <li>Giao hàng miễn phí trong phạm vi nội thành</li>
                <li>Hỗ trợ thanh toán khi nhận hàng (COD), thẻ tín dụng, và chuyển khoản ngân hàng</li>
                <li>Hỗ trợ 24/7 suốt thời gian sử dụng.
                    <br>Hotline:
